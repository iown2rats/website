...
| `--color-sand` / `--color-on-sand` | `#C6A962` / `#3B2F2A` | `#E0C27A` / `#1A1412` | Thundi Plus gold: Plus tags, plan badges, Premium labels, the Plus hero disc, the active-Plus card icon. Nothing else is gold |
