...
/**
 * The Google account that just signed in belongs to a Thundi account that was deleted (docs/ARCHITECTURE.md §4.4).
  ...
  return (
    <main className="fixed inset-0 flex flex-col items-center justify-center bg-background px-5 text-text">
      <div className="flex w-full max-w-[var(--onboarding-max)] flex-col gap-4">
        ...
        <h1 className="text-h2">Your previous Thundi account was deleted</h1>
        <p className="text-body text-text-secondary">
          <span className="font-semibold text-text">{pending.email}</span> was used for a Thundi account that has since been deleted. Its profile, photos, matches, chats and posts are gone and can&apos;t be restored.
        </p>
